 ...
 * @return {TypeName}
 */
function hd_NumberToChinese(num) {
...
/* 文件大小转换为MB GB KB格式 */
function hd_countFileSize(size) {
...
/* 获取文件名称 */
function hd_getFileName(fileName) {
	var pos = fileName.lastIndexOf("/") + 1;
	if (pos == -1) {
		return fileName;
	} else {
...
//将string或者arry或者object转成json格式数据
